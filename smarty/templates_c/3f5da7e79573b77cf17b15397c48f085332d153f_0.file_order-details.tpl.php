<?php
/* Smarty version 5.5.1, created on 2025-06-20 07:51:07
  from 'file:admin/order-details.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.5.1',
  'unifunc' => 'content_685512eb75cc51_39318558',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3f5da7e79573b77cf17b15397c48f085332d153f' => 
    array (
      0 => 'admin/order-details.tpl',
      1 => 1750405846,
      2 => 'file',
    ),
  ),
...
function content_685512eb75cc51_39318558 (\Smarty\Template $_smarty_tpl) {
...
<div class="main-content-wrap">
                                <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                                    <div class="d-flex gap-3 align-items-center">
                                        <h3>Order #<?php echo $_smarty_tpl->getValue('orderDetails')['id'];?>
</h3>
                                        <p class="bg bg-<?php echo $_smarty_tpl->getValue('status_color');?>
 text-white rounded py-2 px-4 ms-4 fs-5"><?php echo $_smarty_tpl->getValue('orderDetails')['status'];?>
</p> 
                                        <a class="fs-6" style="text-decoration: underline;" data-bs-toggle="modal" data-bs-target='#updateStatusModal' data-orderid='<?php echo $_smarty_tpl->getValue('orderDetails')['id'];?>
'>Update Status</a>
                                    </div>
                                    ...
                                    <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                                        ...
                                        <li>
                                            <div class="text-tiny">Order #<?php echo $_smarty_tpl->getValue('orderDetails')['id'];?>
</div>
                                        </li>
                                    </ul>
                                </div>
                                        ...
                                        <div class="wg-box mb-20">
                                            <div class="wg-table table-order-detail">
                                                ...
                                                <ul class="flex flex-column">
                                                    ...
                                                    <?php
$_from = $_smarty_tpl->getSmarty()->getRuntime('Foreach')->init($_smarty_tpl, $_smarty_tpl->getValue('orderItems'), 'item');
$foreach0DoElse = true;
...
" alt="">
                                                        ...
                                                        <div class="flex items-center justify-between gap40 flex-grow">
                                                            <div class="name">
                                                                ...
                                                                <a href="#" class="body-title-2"><?php echo $_smarty_tpl->getValue('item')['name'];?>
</a>
                                                            </div>
                                                            <div class="name">
                                                                <div class="text-tiny mb-1">Quantity</div>
                                                                <div class="body-title-2"><?php echo $_smarty_tpl->getValue('item')['quantity'];?>
</div>
                                                            </div>
                                                            <div class="name">
                                                                <div class="text-tiny mb-1">Price</div>
                                                                <div class="body-title-2"><?php echo $_smarty_tpl->getValue('item')['total_price'];?>
</div>
                                                            </div>
                                                        </div>
                                                    </li>
                                            ...
                                            <div class="wg-table table-cart-totals">
                                                ...
                                                <ul class="flex flex-column gap14">
                                                    <li class="cart-totals-item">
                                                        ...
                                                        <span class="body-title-2">₦<?php echo $_smarty_tpl->getValue('orderDetails')['total_amount'];?>
</span>
                                                    </li>
                                                    <li class="divider"></li>
                                                    <li class="cart-totals-item">
                                                    ...
                                                    <li class="cart-totals-item">
                                                        ...
                                                        <span class="body-title tf-color-1">₦<?php echo $_smarty_tpl->getValue('orderDetails')['total_amount'];?>
</span>
                                                    </li>
                                    ...
                                    <div class="right">
                                        <div class="wg-box mb-20 gap10">
                                            ...
                                            <div class="summary-item">
                                                ...
                                                <div class="body-title-2">#<?php echo $_smarty_tpl->getValue('orderDetails')['id'];?>
</div>
                                            </div>
                                            <div class="summary-item">
                                                <div class="body-text">Date</div>
                                                <div class="body-title-2"><?php echo $_smarty_tpl->getValue('orderDetails')['created_at'];?>
</div>
                                            </div>
                                            <div class="summary-item">
                                                <div class="body-text">Total</div>
                                                <div class="body-title-2 tf-color-1">₦<?php echo $_smarty_tpl->getValue('orderDetails')['total_amount'];?>
</div>
                                            </div>
                                        </div>
                                        <div class="wg-box mb-20 gap10">
                                            <div class="body-title">Shipping Address</div>
                                            <div class="body-text">₦<?php echo $_smarty_tpl->getValue('orderDetails')['address'];?>
</div>
                                        </div>
                                        <div class="wg-box mb-20 gap10">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Order #<?php echo $_smarty_tpl->getValue('orderDetails')['id'];?>
</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <p class="mb-3">Update Status for Order #<?php echo $_smarty_tpl->getValue('orderDetails')['id'];?>
</p>

        <form action="order-update" method="post">
          <input type="hidden" name="order_id" value="<?php echo $_smarty_tpl->getValue('orderDetails')['id'];?>
">
          <div class="mb-3">
