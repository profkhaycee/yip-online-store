...
<head>
    ...
    <title>YIP STORE Admin Dashboard - {$page_title}</title>
    ...
    <link rel="apple-touch-icon-precomposed" href="assets/img/yip-icon.jpeg">

    <style>

        #logo_header, #logo_header_mobile{
                ...
                <div class="section-menu-left">
                    <div class="box-logo">
                        <a href="index" id="site-logo-inner">
                            <img class="" id="logo_header" alt="" src="assets/img/yip-logo.png">
                        </a>
                            ...
                            <ul class="menu-list">
                                ...
                                {* <li class="menu-item has-children">
                                    <a href="javascript:void(0);" class="menu-item-button">
                                        ...
                                        <div class="text">Item Attributes</div>
                                    </a>
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                ...
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        {* <li class="sub-menu-item">
                                            <a href="order-details" class="">
                                                <div class="text">Order detail</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="order-tracking" class="">
                    ...
                    {* <div class="bot text-center">
                        <div class="wrap">
                            <div class="mb-20">
                                <img src="assets/admin/images/menu-left/img-bot.png" alt="">
                            </div>
                            <div class="mb-20">
                    ...
                    <div class="header-dashboard">
                        <div class="wrap">
                            <div class="header-left">
                                <a href="index">
                                    {* <img class="" id="logo_header_mobile" alt="" src="assets/admin/images/logo/logo.png" data-light="assets/admin/images/logo/logo.png" data-dark="assets/admin/images/logo/logo-dark.png" data-width="154px" data-height="52px" data-retina="assets/admin/images/logo/logo@2x.png"> *}
                                    <img class="" id="logo_header_mobile" alt="" src="assets/img/yip-logo.png" data-light="assets/img/yip-logo.png" data-dark="assets/img/yip-logo.png" data-width="154px" data-height="52px" data-retina="assets/img/yip-logo.png">
                                </a>
                                <div class="button-show-hide">
                                    <i class="icon-menu-left"></i>
                                </div>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end has-content" aria-labelledby="dropdownMenuButton1" >
                                            ...
                                            <li>
                                                <div class="noti-item w-full wg-user active">
                                                    <div class="image">
                                                        <img src="assets/admin/images/avatar/user-11.png" alt="">
                                                    </div>
                                                    <div class="flex-grow">
                                            ...
                                            <li>
                                                <div class="noti-item w-full wg-user active">
                                                    <div class="image">
                                                        <img src="assets/admin/images/avatar/user-12.png" alt="">
                                                    </div>
                                                    <div class="flex-grow">
                                                        <div class="flex items-center justify-between">
                                            ...
                                            <li>
                                                <div class="noti-item w-full wg-user active">
                                                    <div class="image">
                                                        <img src="assets/admin/images/avatar/user-13.png" alt="">
                                                    </div>
                                                    <div class="flex-grow">
                                                        <div class="flex items-center justify-between">
